  ...
  <body>
    ...
    <div class="navbar" style="background-color: #4A503D; height: 60px">
        <div class="container">
            ...
            <div class="col-sm-5">
                <img src="images/user.png" align="right" style="width:40px; height:40px;margin-top:-13px;margin-right:60px;">
            </div>
      ...
      <div class="image" >
        <img src="images/union.png" style="width: 1440px; height: 540px;px;">
      </div>
      <div class="pink" style="background-color:#E28F83; height: 110px;box-shadow: 5px 4px 3px #8E9775;">
        ...
        <div class="container"><br>
            <div class="row" style="text-align:center;">
                <span class="col-sm-3" >
                    <div style="text-shadow: 4px 4px 4px black;width: 1000px; height:282px;border-radius:40px;margin-top:-45px;margin-left:150px;font-family:roboto;font-weight: bolder;font-size: 70px;color: #4A503D;">U N I O N
                </div>
            </div>
        </div>
        <br>
        ...
        <center></center>
        <img src="images/logo.png" style="width:1200px; height:1200px;margin-top:-250px;margin-left:150px;position:absolute;opacity:0.3;">
        </center>
        <br>
            <br>
            <div class="container"><br>
            ...
            <br><div class="container"><br>
                <div class="row" style="text-align:right;">
                    ...
                    <span class="col-sm-3" >
                        <div style="text-shadow: 2px 0px 3px #8E9775;width: 1000px; height:282px;border-radius:40px;margin-top:-215px;margin-left:110px;font-family:roboto;font-weight: bolder;font-size: 20px;color: #4A503D;">Plaza Senayan Ground Floor, Jl. Asia Afrika No. 8, RT.1/RW.3,<br>Gelora, Kecamatan Tanah Abang, KotaJakarta Pusat,<br>Daerah Khusus Ibukota Jakarta 10270 - (021)72781145
                    </div>
                </div>
            <br>
            </div>
        ...
        <div class="container"><br>
            <div class="row" style="text-align:center;margin-bottom: 70px;">
                <div class="col-sm-4" >
                    <img src="images/menu1.png" style="box-shadow: 5px 4px 3px #8E9775;width:328px; height:500px;border-radius:10px;">
                </div>
                <div class="col-sm-4">
                    <img src="images/menu2.png" style="box-shadow: 5px 4px 3px #8E9775;width:328px; height:500px;border-radius:10px;">
                </div>
                <div class="col-sm-4">
                    <img src="images/menu3.png" style="box-shadow: 5px 4px 3px #8E9775;width:328px; height:500px;border-radius:10px;">

                </div>
                <div class="col-sm-4">
                    <button type="button"  onclick="window.location='http://127.0.0.1:8000/reservasi'" class="btn" style="box-shadow: 5px 4px 3px #8E9775;color:#FAF2DA; background-color:#E28F83;width: 350px; height:60px;border-radius:10px;margin-top:50px;margin-bottom:30px;margin-left:475px;font-family:roboto;font-weight: bolder;font-size: 30px;">Reserve A Seat</button>
                </div>
            </div>
        </center>
