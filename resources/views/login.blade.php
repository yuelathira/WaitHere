...
<html lang="en">
  ...
  <body>
    ...
    <div class="navbar" style="background-color: #4A503D; height: 60px">
      ...
      <center></center>
        <img src="img/logo.png" style="width:1200px; height:1200px;margin-top:-250px;margin-left:150px;position:absolute;opacity:0.3;">
        ...
        <div class="box" align="center" style="position:relative;">
            <div class="content">
                <header>
                    <h2><img src="img/user__1__1.png"></h2>
                </header>
                <form>
                    ...
                    <div class="account" style="letter-spacing: 1px;"> <a style="color: #4A503D; text-decoration: none" href="/register">Create Account</a></div>
                </form>
            </div>
        </div>
    </center>
