        ...
        <div class="navbar" style="background-color: #4A503D; height: 60px">
            <div class="container">
                ...
                <div class="col-sm-8" align="right" style="color: #FAF2DA;font-family: roboto;font-weight: bold; font-size:20px;margin-top:-75px;margin-left:450px;">
                    <a style="color: #FAF2DA; text-decoration: none" href="/login">Login</a><a>Login</a>
                    </div>
                </div>
              </div>
        <center>
        ...
        <div class="box" align="center"style="position:relative;">
            <div class="content">
                <form><br>
                    ...
                    <br><br>
                    <input style="color:#FAF2DA; font-size: 18px;" type="submit" id="register" name="register" value="REGISTER">
                    <br><br><br>
                    <div class="account">Have an account? <a style="color: #4A503D; text-decoration: none" href="/login">Login now!</a></div>
                </form>
            </div>
        </div>
    </center>
