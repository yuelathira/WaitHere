  ...
  <body>
    ...
    <div class="navbar" style="background-color: #4A503D; height: 60px">
        <div class="container">
            ...
            <div class="col-sm-5">
                <img src="img/home/user.png" align="right" style="width:40px; height:40px;margin-top:-13px;margin-right:60px;">
            </div>
      ...
      <div class="image" >
        <img src="img/home/waithere!.png" style="width: 1440px; height:1100px;">
      </div>
      <div class="pink" style="background-color:#E28F83; height: 350px;box-shadow: 5px 4px 3px #8E9775;">
        ...
        <div class="container"><br>
            <div class="row" style="text-align:center;">
                <div class="col-sm-3" >
                    <button type="button" class="btn" style="box-shadow: 5px 4px 3px #8E9775;color:#4A503D; background-color:#FAF2DA; width: 200px; height:50px; border-radius:40px;">Brunch</button>
                </div>
                <div class="col-sm-3">
                    <button type="button" class="btn" style="box-shadow: 5px 4px 3px #8E9775;color:#4A503D; background-color:#FAF2DA;width: 200px; height:50px;border-radius:40px;">Bar & Lounge</button>
                </div>
                <div class="col-sm-3">
                    <button type="button" class="btn" style="box-shadow: 5px 4px 3px #8E9775;color:#4A503D; background-color:#FAF2DA;width: 200px; height:50px;border-radius:40px;">Fast Food</button>
                </div>
                <div class="col-sm-3">
        ...
        <div class="container"><br>
            <div class="row" style="text-align:center;">
                <div class="col-sm-3" >
                    <button type="button" class="btn" style="box-shadow: 5px 4px 3px #8E9775;color:#4A503D; background-color:#FAF2DA; width: 200px; height:50px; border-radius:40px;">Casual Dining</button>
                </div>
                <div class="col-sm-3">
                    <button type="button" class="btn" style="box-shadow: 5px 4px 3px #8E9775;color:#4A503D; background-color:#FAF2DA;width: 200px; height:50px;border-radius:40px;">All You Can Eat</button>
                </div>
                <div class="col-sm-3">
                    <button type="button" class="btn" style="box-shadow: 5px 4px 3px #8E9775;color:#4A503D; background-color:#FAF2DA;width: 200px; height:50px;border-radius:40px;">Beverages</button>
                </div>
                <div class="col-sm-3">
                    <button type="button" class="btn" style="box-shadow: 5px 4px 3px #8E9775;color:#4A503D; background-color:#FAF2DA;width: 200px; height:50px;border-radius:40px;">Live Music</button>
                </div>
            </div>
        </div>
        <br>
        <div class="container"><br>
            <div class="row" style="text-align:center;">
                <div class="col-sm-3" >
                    <button type="button" class="btn" style="box-shadow: 5px 4px 3px #8E9775;color:#4A503D; background-color:#FAF2DA; width: 200px; height:50px; border-radius:40px;">Fine Dining</button>
                </div>
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    <button type="button" class="btn" style="box-shadow: 5px 4px 3px #8E9775;color:#4A503D; background-color:#FAF2DA;width: 200px; height:50px;border-radius:40px;">Street Food</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container"><br>
		<div class="row" style="text-align:center;">
			<div class="col-sm-4" >
				<img src="img/home/amuz.png" style="box-shadow: 5px 4px 3px #8E9775;width:278px; height:164px;border-radius:10px;">
			</div>
			<div class="col-sm-4">
				<img src="img/home/hensin.png" style="box-shadow: 5px 4px 3px #8E9775;width:278px; height:164px;border-radius:10px;">
			</div>
			<div class="col-sm-4">
				<img src="img/home/namaaz.png" style="box-shadow: 5px 4px 3px #8E9775;width:278px; height:164px;border-radius:10px;">
        ...
        <div class="container"><br>
            <div class="row" style="text-align:center;">
                <div class="col-sm-4" >
                    <img src="img/home/3wise.png" style="box-shadow: 5px 4px 3px #8E9775;width:278px; height:164px;border-radius:10px;">
                </div>
                <div class="col-sm-4">
                    <img src="img/home/pizza.png" style="box-shadow: 5px 4px 3px #8E9775;width:278px; height:164px;border-radius:10px;">
                </div>
                <div class="col-sm-4">
                    <img src="img/home/dear.png" style="box-shadow: 5px 4px 3px #8E9775;width:278px; height:164px;border-radius:10px;">
    ...
    <div class="footer" style="background-color:#4A503D; height:250px;color: #FAF2DA; margin-top:10px; padding-top: 5px;">
        ...
        <div class="container">
            <div class="row" style="text-align:left;">
                ...
                <img src="img/home/logo.png" style=" width:270px;height:270px;margin-top:-230px;margin-left:1070px;">
            </div>
        </div>
    </div>
